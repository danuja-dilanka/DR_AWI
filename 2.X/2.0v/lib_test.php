...
$img->setCaption("Yea! It's,", "m(10,150)");
//
////$img->setBorder(50, "0,0,25","l");
////$img->setFont(1, 20, "255,255,255");
////$img->setTopBlockColour("0,0,0");
//
$img->setBorder(20, "0,0,25");
$img->addNewImage(null, "500,1000", "500,0", "EFF_OVERLAY");
$img->addNewImage(null, "200,500", "200,0", "EFF_OVERLAY");
$img->setCaption("2020", "M(700,270)", 50, '255,255,255');
